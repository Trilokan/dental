...
class ReportPurchaseValue(models.TransientModel):
    _name = "report.purchase.value"
    ...
    detail_ids = fields.One2many(comodel_name="report.purchase.value.detail", inverse_name="report_id")
...
class ReportPurchaseValueDetail(models.TransientModel):
    _name = "report.purchase.value.detail"
    ...
    report_id = fields.Many2one(comodel_name="report.purchase.value", string="Purchase")
