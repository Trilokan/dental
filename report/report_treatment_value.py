...
class ReportTreatmentValue(models.TransientModel):
    _name = "report.treatment.value"
    ...
    detail_ids = fields.One2many(comodel_name="report.treatment.value.detail", inverse_name="report_id")
...
class ReportTreatmentValueDetail(models.TransientModel):
    _name = "report.treatment.value.detail"
    ...
    report_id = fields.Many2one(comodel_name="report.treatment.value", string="Treatment")
